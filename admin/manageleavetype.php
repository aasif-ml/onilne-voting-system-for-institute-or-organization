    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Manage Candidate</div>
                    </div>
...
{               ?>  
                                        <tr>
											...
											<td><?php echo htmlentities($result->etitle);?></td>
                                            <td><?php echo htmlentities($result->cid);?></td>
                                            <td><?php echo htmlentities($result->cname);?></td>
											<td><?php echo htmlentities($result->cdept);?></td>
											<td><?php echo htmlentities($result->cdesc);?></td>
											<td><?php echo htmlentities($result->cimg);?></td>
											<td><?php echo htmlentities($result->csimg);?></td>
