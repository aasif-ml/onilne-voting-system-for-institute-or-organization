...
$sql="INSERT INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:address,:city,:country,:mobileno,:status)";
...
<label for="empcode">Student USN(Must be unique)</label>
...
<div class="input-field col s12">
<button type="submit" name="add" onclick="return valid();" onclick="../index.php" onclick="index.php" href="index.php" id="add" class="waves-effect waves-light btn indigo m-b-xs">REGISTER</button>
<input type="button" onclick="window.location.href='../index.php';" value="Back to login" class="waves-effect waves-light btn indigo m-b-xs">
